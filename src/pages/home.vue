...
<template>
  <div>
    <Navbar />
    <filter-modal v-if="isModal" @closeModal="closeModal" />
      ...
      <div class="container">
        <div class="flex justify-between items-center">
          <div class="flex rounded overflow-hidden">
            <RouterLink
              class="border-2 text-primary border-[#E0E7FF] w-[190px] block text-center py-3.5 text-xs font-medium uppercase tracking-[1.125px]"
              to="/">Dashboard</RouterLink>
            <RouterLink
              class="border-2 border-x-0 text-primary border-[#E0E7FF] w-[190px] block text-center py-3.5 text-xs font-medium uppercase tracking-[1.125px]"
              to="/sponsors">homiylar</RouterLink>
            <RouterLink
              class="border-2 text-primary border-[#E0E7FF] w-[190px] block text-center py-3.5 text-xs font-medium uppercase tracking-[1.125px]"
              to="/students">talabalar</RouterLink>
          </div>
          <div class="flex gap-5">
            <div class="relative">
              ...
              <input class="bg-[#E8E8E8] rounded p-2.5 pl-10 focus:outline-none" type="text" placeholder="Izlash">
            </div>
            <button @click="isModal = true" class="flex gap-2.5 text-primary bg-[#EDF1FD] py-2 px-8 rounded items-center">
              <span>
